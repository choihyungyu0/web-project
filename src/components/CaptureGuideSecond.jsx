  ...
  return (
    <PageWrapper>
      <Container>
        ...
        <BackArrow onClick={() => navigate('/CaptureGuideFirst')}>❮</BackArrow>
        <ContentContainer>
          <CaptureBox
            imageKey="SmartphoneGuideSecond_0"
            alt="이미지캡처"
          />
          {isMounted && (
          ...
          {!isMounted && (
            <>
              <NextButton onClick={()=>navigate('/CaptureGuideThird')}>다음으로 넘어가기</NextButton>
            </>
          )}
        </ContentContainer>
...
export default CaptureGuideSecond;
