  ...
  return (
    <PageWrapper>
      <Container>
        ...
        <BackArrow onClick={() => navigate('/CaptureGuideSecond')}>❮</BackArrow>
        <ContentContainer>
          <CaptureBox
            imageKey="SmartphoneGuideThird_0"
            alt="이미지캡처"
          />
          {isMounted && (
          ...
          {!isMounted && (
            <>
              <NextButton onClick={()=>navigate('/CaptureGuideFourth')}>다음으로 넘어가기</NextButton>
            </>
          )}
        </ContentContainer>
...
export default CaptureGuideThird;
